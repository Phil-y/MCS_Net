...
class MFCrossAttention(nn.Module):
    def __init__(self, in_dim):
        super(MFCrossAttention, self).__init__()
    ...
    def forward(self, x):
        ...
        return self.mwf(self.gamma * (out_H + out_W) + x)
    ...
    def __init__(self, dim, depth, mlp_ratio=4):
        ...
        for _ in range(depth):
            self.layers.append(nn.ModuleList([
                PreNorm(dim, MFCrossAttention(dim)),
